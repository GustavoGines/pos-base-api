...
class ReportController extends Controller
{
    public function profitByCategory(Request $request)
    {
        ...
        $report = $productStats->groupBy('category_name')->map(function ($items, $categoryName) {
            return [
        ...
        // En algunos gestores de BD puede requerirse comillas en campos de grupo
        $dailySales = \Illuminate\Support\Facades\DB::table('sales')
