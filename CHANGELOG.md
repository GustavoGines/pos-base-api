...
Todos los cambios del servidor API est�n documentados aqu�.
...
## [1.6.4] - 2026-08-26
### Mejoras
- Sincronizaci�n de versi�n con el cliente de escritorio (Mejora UX sin clics intermedios).

## [1.6.3] - 2026-08-26
### Mejoras
- Sincronizaci�n de versi�n con el cliente de escritorio (mejoras de UX en el actualizador).

## [1.6.2] - 2026-08-26
### Correcciones
- Compatibilidad de versi�n con el frontend.
...
- **Integración Continua (CI/CD):** Configuración de GitHub Actions para ejecutar automáticamente la suite de tests (con PHP 8.3) en cada `push` o `pull request`, asegurando la estabilidad del código en la nube antes de cualquier despliegue a producción.
